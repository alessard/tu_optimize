...
##Version 1.1.4
* Added support for Fortress Cards: 
they will be played out along with a players commander
climb not supported if they are contained within a decks card list
new commandline arguments (afort <cardlist>, dfort <cardlist>) added to set global fortress cards which are used for all simulations including climb 
* Added last "good" version of <code>cards.xml</code> and <code>missions.xml</code>
